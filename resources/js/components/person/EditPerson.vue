<template>
    <div>
      ...
      <h2 class="mb-0">Update Person Details</h2>
  ...
  created(){
    ...
    created() {
    // Access the person data passed from the router
   // this.person = this.$route.params.person;

   this.fetchLanguages();
          this.id =  this.$route.params.person.id;
          this.name =  this.$route.params.person.name;
          this.surname = this.$route.params.person.surname;
          this.sa_id_number = this.$route.params.person.sa_id_number;
          this.mobile_number = this.$route.params.person.mobile_number;
          this.email = this.$route.params.person.email;
          this.birth_date = this.$route.params.person.birth_date;

          this.language = this.$route.params.person.language;
          this.interests = this.$route.params.person.interests;
  ...
  this.isSubmitting = true;
        ...
        axios.post('/api/persons/update', {
          ...
          .then(response => {
            ...
            self.$swal.fire({
							title: 'Succesfully updated information and sent confirmation to the user',
							showDenyButton: true,
